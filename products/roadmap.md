...
The next minor release 1.0.0 aka **Iron Knight** will probably released on **05/2015**. As we actually have no verified timetable for our [EE](<{{ "/products/enterprise-edition.html" | prepend: site.baseurl }}>), this date can change, due to customer needs for EE features. 
