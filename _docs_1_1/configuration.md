...
As this is a large topic, we've separated the [Managers](<{{ "/get-started/documentation/managers.html" | prepend: site.baseurl }}>) documentation to a new page, which contains all the necessary information you need to understand which managers are available, how they can be configured and how a new Manager can be implemented.
