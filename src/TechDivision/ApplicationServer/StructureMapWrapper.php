...
class StructureMapWrapper extends StructureMap
{
    ...
    /**
     * @var \TechDivision\ApplicationServer\GenericStackable $map The actual container for the map
     */
    protected $stackableMap;

    /**
     * @var \TechDivision\ApplicationServer\InitialContext $initialContext Our initial context
     */
     ...
     * @param \TechDivision\ApplicationServer\InitialContext $initialContext   Our initial context
     */
     ...
     *
     * @return \TechDivision\ApplicationServer\InitialContext InitialContext
     */
