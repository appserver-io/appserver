...
/**
 * \AppserverIo\Appserver\Core\Api\Node\AnnotationRegistriesNodeTrait
 *
 * NOTICE OF LICENSE
 *
...
trait AnnotationRegistriesNodeTrait
{
     ...
     *
     * @var array
     * @AS\Mapping(nodeName="annotationRegistries/annotationRegistry", nodeType="array", elementType="AppserverIo\Appserver\Core\Api\Node\AnnotationRegistryNode")
     */
