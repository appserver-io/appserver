...
/**
 * AppserverIo\Appserver\Core\Commands\MigrationsCommand
 *
 * NOTICE OF LICENSE
 *
...
use AppserverIo\Appserver\Core\Commands\Helper\ConfigurationHelper;
...
class MigrationsCommand extends AbstractCommand
{
     ...
     */
    protected function doMigrations(array $command = array())
    {
        ...
        try {
            ...
            $helperSet->set(new ConfigurationHelper($application, $entityManager->getConnection()));

            // create the Symfony Console application
            /** \Symfony\Component\Console\Application $app */
            $app = \Doctrine\DBAL\Migrations\Tools\Console\ConsoleRunner::createApplication($helperSet);
            $app->setAutoExit(false);

            // as Doctrine CLI uses Symfony Console component, we've to simulate the commandline args
            $argv = array(MigrationsCommand::COMMAND);
