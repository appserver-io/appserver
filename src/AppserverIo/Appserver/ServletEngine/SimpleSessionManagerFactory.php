...
/**
 * \AppserverIo\Appserver\ServletEngine\SimpleSessionManagerFactory
 *
 * NOTICE OF LICENSE
 *
...
/**
 * A factory for the simple session manager instances.
 *
 * @author    Tim Wagner <tw@appserver.io>
 * @copyright 2015 TechDivision GmbH <info@appserver.io>
 * @license   http://opensource.org/licenses/osl-3.0.php Open Software License (OSL 3.0)
 ...
 * @link      http://www.appserver.io
 */
class SimpleSessionManagerFactory implements ManagerFactoryInterface
{
